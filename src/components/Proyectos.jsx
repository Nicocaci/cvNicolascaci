...
export default function Proyectos() {
    return (
        <section id='proyectos' className="seccionProyectos text-white ps-5 pe-5 pt-5">
            <h3 className="titulos mb-5">Mis Proyectos</h3>
            <div className="row contenedorProyectos ">
                <div className="col">
                    <div className="card  bg-dark cardproyectos text-white cardContenedora">
                        ...
                        <h4 className="center mt-3 titulosProyectos">Virtual Hockey Store</h4>
                        <p className="center mt-3 pe-3 ps-3 textoProyectos">VirtualHockeyStore es una aplicación ecommerce responsive desarrollada con React para la venta de productos relacionados con el hockey. La tienda incluye características como búsqueda de productos, filtrado, carrito de compras y procesamiento de pagos.</p>
                ...
                <div className="col">
                    <div className="card bg-dark cardproyectos text-white">
                        ...
                        <h4 className='center mt-4 titulosProyectos'>Quilmes Atletico Club</h4>
                        <p className='center mt-4 pe-3 ps-3 textoProyectos'>Quilmes Atletico Club es un proyecto responisve basico, el cual cuenta con una barra de navegacion, diferentes pages, las cual se pueden ir navegando, segun gustes. Cuenta con un inicio, galeria, contacto y ubicacion.</p>
                        <div className='d-flex center '>
                            <div className='center me-2'>
