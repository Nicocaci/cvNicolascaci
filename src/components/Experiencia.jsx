...
export default function Experiencia() {
    return (
        <section id='experiencia' className="seccionExperiencia text-white ps-5 pe-5 pt-5 ">
            ...
            <div className="row cardExperiencia m-auto ">
                <div className="card bg-dark col me-3 certificado">
                ...
                <div className="card bg-dark col certificado">
            ...
            <div className='row certificado m-auto cardExperiencia'>
            <div className="card bg-dark col certificado">
                    <h4 className="text-white center mt-5 mb-5">Desarollador Frontend React</h4>
